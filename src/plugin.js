/**
* @overview Uses [UploadCare](https://uploadcare.com/) service to upload images and render them in chats. <br> <img src="plugins/chat-engine-uploadcare/output.gif" height="400"></img> <br>
